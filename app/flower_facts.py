...
flower_facts = {
    ...
    "calendula": {
        "description": "Calendula, also known as pot marigold, is a cheerful flower with bright orange or yellow petals that look like mini suns. It's not just a pretty face—calendula has been used for centuries in herbal medicine and cooking. Its petals are even edible!",
...
with open("flower_facts.json", "w", encoding="utf-8") as f:
    json.dump(flower_facts, f, ensure_ascii=False, indent=4)